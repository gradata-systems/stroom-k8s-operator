...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StroomClusterRef) DeepCopyInto(out *StroomClusterRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StroomClusterRef.
func (in *StroomClusterRef) DeepCopy() *StroomClusterRef {
	if in == nil {
		return nil
	}
	out := new(StroomClusterRef)
	in.DeepCopyInto(out)
	return out
}
