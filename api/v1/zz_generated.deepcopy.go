...
func (in *NodeSet) DeepCopyInto(out *NodeSet) {
	*out = *in
	...
	in.Affinity.DeepCopyInto(&out.Affinity)
	out.TaskAutoScaleOptions = in.TaskAutoScaleOptions
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TaskAutoScaleOptions) DeepCopyInto(out *TaskAutoScaleOptions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TaskAutoScaleOptions.
func (in *TaskAutoScaleOptions) DeepCopy() *TaskAutoScaleOptions {
	if in == nil {
		return nil
	}
	out := new(TaskAutoScaleOptions)
	in.DeepCopyInto(out)
	return out
}
